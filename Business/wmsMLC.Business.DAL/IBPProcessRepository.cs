...
{
    public interface IBPProcessRepository : IRepository<BPProcess, string>
    {
        ...
        void RemoveStorageUnit(IEnumerable<decimal> productId);
        ...
        // Получение Place для ТЕ
        void BpGetPlaceByMM(string MMCode, string SourceTeCode, ref string MMStrategy, string OrderClause, out string PlaceCode);
        ...
        /// Квитирование ЗНТ
        /// </summary>
        /// <param name="tTaskIDLst">коллекция кодов ЗНТ</param>
        /// <param name="workerCode">код рабочего</param>
        /// <param name="truckCode">код трака</param>
        /// <param name="startDate">дата начала</param>
        /// <param name="endDate">дата окончания</param>
        /// <param name="teTypeCode">код типа временной ТЕ (для частичного перемещения)</param>
        /// <param name="teCodeLst">Код базовой несущей ТЕ(для стратегий *_TE2TE_CREATE)</param>
        /// <param name="isNotNeededCreateWork">Не создавать работу</param>
        ...
        //Добавление в очередь поставок + возврат id очереди
        ...
        //Деактивировать позицию списка пикинга
        ...
        /// упаковать товар
        /// </summary>
        /// <param name="productIdLst">список id товара</param>
        /// <param name="changedProducts">список измененных товаров</param>
        /// <param name="packTE">код упаковки</param>
        /// <param name="packCount">кол-во для упаковки</param>
        /// <param name="packFullProduct">паковать весь товар</param>
        ...
        /// <param name="productIdLst">список id товара</param>
        /// <param name="changedProducts">список измененных товаров</param>
        /// <param name="packTECode">код упаковки</param>
        /// <param name="skuId">id упаковочного SKU</param>
        /// <param name="packProductCountSKU">кол-во для упаковки</param>
        /// <param name="isEnablePackOtherSKU">паковать в другом SKU</param>
        ...
        /// <summary>
        /// Упаковать товар на ТЕ
        /// </summary>
        /// <param name="productId">ИД товара</param>
        /// <param name="packTE">Код ТЕ-упаковки</param>
        /// <param name="packCount">Кол-во, которое требуется упаковать</param>
        void PackProduct(decimal productId, string packTE, decimal packCount);

        /// <summary>
        /// распаковать
        /// </summary>
        /// <param name="productID">ID товара на распаковку</param>
        ...
        /// закрыть короб
        /// </summary>
        /// <param name="teCode">код те для закрытия</param>
        ...
        /// открыть короб
        /// </summary>
        /// <param name="teCode">код те для открытия</param>
        /// <param name="operationCode">код операции</param>
        ...
        string CheckPackOWB(decimal productId, int? checkWh);
        ...
        // Рассчитать маршруты
        List<string> ChangeOWBRoute(IEnumerable<decimal> OWBIDLst, decimal? routeID, DateTime? planDate = null, bool changeDate = true, bool changeRoute = true);
        ...
        // Получение очередного задания по группе
        ...
        string GetSdclEndPoint(string clientCode, ref string prevServiceCode);
