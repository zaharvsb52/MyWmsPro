...
/// --------------------------------------------------------------------------------------
/// <Copyright File="FRExcel2007.cs" Company="ЗАО Логистическая компания МОЛКОМ">
///   Copyright (c) ЗАО Логистическая компания МОЛКОМ. All rights reserved.
/// </Copyright>
/// <Author>Olga Marysheva</Author>
/// <Date>20.09.2012 13:42:12</Date>
/// <Summary>Экпорт отчетов в файлы Excel 2007</Summary>
/// --------------------------------------------------------------------------------------
...
namespace wmsMLC.EPS.wmsEPS.ExportFormat
{
    ...
    /// </summary>
    public class FRExcel2007 : IExportFormat
    {
        private readonly FastReport.Export.OoXML.Excel2007Export _exp = new FastReport.Export.OoXML.Excel2007Export();
