...
namespace wmsMLC.DCL.Content.ViewModels
{
    ...
    public class OWBPosViewModel : ObjectViewModelBase<OWBPos>
    {
        protected override void SourceObjectPropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
        {
            ...
            if (!e.PropertyName.EqIgnoreCase(OWBPos.OWBID_RPropertyName) &&
                !e.PropertyName.EqIgnoreCase(OWBPos.SKUIDPropertyName))
                return;
            ...
            var parentModelSource = ((IModelHandler)this).ParentViewModelSource as OWB;
            if (parentModelSource != null && e.PropertyName.EqIgnoreCase(OWBPos.SKUIDPropertyName) && Source.SKUID > 0)
            {
                ...
                if (art.First().MANDANTID != parentModelSource.MandantID)
                {
                    ...
                    Source.SKUID = (decimal)Source.GetPropertyDefaultValue(OWBPos.SKUIDPropertyName);
                }
            }
        }
        ...
        protected override System.Collections.ObjectModel.ObservableCollection<wmsMLC.General.PL.Model.DataField> GetFields(wmsMLC.General.PL.SettingDisplay displaySetting)
        {
            ...
            var f = fields.FirstOrDefault(i => i.Name.EqIgnoreCase(OWBPos.SKUIDPropertyName));
            if (f != null)
            {
